...
$response = array();
 ...
 $checkQuery = "SELECT l.`l_id`,d.`l_name`,l.`email_id`, l.`contact_no`,d.`address`,l.`status`, d.`dob`, d.`gender`  FROM `tbl_detail` d INNER JOIN `tbl_login` l ON d.`l_id`=l.`l_id` ORDER BY l.`l_id` "; // change here.
